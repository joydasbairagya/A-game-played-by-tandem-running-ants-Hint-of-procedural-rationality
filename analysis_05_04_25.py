...
epsilon = 1/4
b= epsilon * (Total_distance/velosity_R + Total_distance/velosity_T)
...
b_time = b*np.ones(len(All_time)) + All_time
...
stat2, pval2 = wilcoxon(b_time, l_l1_VT)

mean1 = np.mean(b_time - l1_VT)
mean2 = np.mean(b_time - l_l1_VT)
